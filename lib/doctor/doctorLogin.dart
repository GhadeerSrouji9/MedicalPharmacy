...
import 'package:untitled/animations/bottomAnimation.dart';
import 'package:untitled/doctor/doctorPanel.dart';
                            ...
                            onPressed: ()  {
                              setState(() {
                                ...
                                !validateName & !validateCNICVar ? getInfoAndLogin() :
                                    Toast.show("Empty Field(s) Found!", backgroundColor: Colors.red, backgroundRadius: 5, duration: Toast.lengthLong);
